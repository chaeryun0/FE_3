...
// 회전 초밥 문제 처럼 몇 번씩 순회를 돌아야 하고, 중간에 먹는 초밥이 사라진다라고 하면 for를 이용
// 아래와 같이 for 문 안에 length가 줄어드는 것을 '이용'해야 함
l = [10, 20, 30, 40, 50];
