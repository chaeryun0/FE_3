...
for (i of value2){ // of로 순회를 돌아 key와 value를 한꺼번에 출력하기 위함 -> error
    console.log(i)
}
...
[a, [...b], c] = [10, [20, 30, 40], 50]; // (3) [10, Array(3), 50]
[a, b, c] = [10, [20, 30, 40], 50] // (3) [10, Array(3), 50]
...
// [...a, b, c] = [10, 20, 30, 40, 50] // (X)
[a, b, c] = [[data[0], data[1], data[2]], data[3], data[4]]; // O
[a, b, c] = [[10, 20, 30], 40, 50] // (3) [Array(3), 40, 50]

// 문제 3 (정상 작동)
// a, b, c로 각각을 분해할 것입니다.
// a에는 10, b에는 20 c에는 30, 40, 50을 할당해보세요.
[a, b, c] = [10, 20, [30, 40, 50]] // (3) [10, 20, Array(3)]
